...
public class InitData implements CommandLineRunner {
    ...
    public void run(String... args)throws Exception{
        ...
        /***
         try {
         frequency = Long.parseLong(args[0]);
         duration = Long.parseLong(args[1]);
         System.out.println("Data Freq: " + frequency + "Data Duration:" + duration);
         InitThread obj = new InitThread(routeService,duration, frequency);
         Thread t = new Thread(obj);
         t.start();
         } catch (NumberFormatException e) {
         // TODO Auto-generated catch block
         System.out.println("Please enter Frequency in miliseconds and duration in seconds");
         e.printStackTrace();
         }
         ***/
