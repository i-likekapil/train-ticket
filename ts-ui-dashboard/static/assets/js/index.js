...
var reserveApp = new Vue({
    ...
    methods: {
        ...
        searchTravel() {
            console.log("Search Travel called");
        ...
        queryForTravelInfo(data, path) {
            ...
            $.ajax({
                ...
                error: function (){
                    ...
                    // alert("Some error occurred in Backend Service. Please try again");
                    // $('#alertMessage').html('Some error occurred in Backend Service. Please try again');
